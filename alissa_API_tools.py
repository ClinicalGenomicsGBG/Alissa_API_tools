...
from tools.helpers import create_patient, create_datafile, create_lab_result, setup_logger
...
def main(accession, sex, alissa_folder, vcf_path, output_folder, size, name_in_vcf, production_instance):
    ...
    if production_instance:
        logger.info(f"Starting upload of {os.path.basename(vcf_path)} to Alissa production instance.")
        ...
        logger.info(f"Starting upload of {os.path.basename(vcf_path)} to Alissa test instance.")
